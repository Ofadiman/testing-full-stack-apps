...
export const Counter: FC<{
  ...
  const [state, setState] = useState<number>(props.initialCount ?? DEFAULT_INITIAL_COUNT)

  return (
    <div>
      <Button
        onClick={() => {
          setState((prev) => prev + (props.incrementBy ?? DEFAULT_INCREMENT_BY))
        }}
      ...
      <Button
        onClick={() => {
          setState((prev) => prev - (props.decrementBy ?? DEFAULT_DECREMENT_BY))
        }}
